...
class NewsPortal extends Component {
                            ...
                            <div className="row SetNews_portal">
                                <div className="col-sm-12">
                                    {this.state.filtered.map(pack =>
                                        <div key={pack.key} className="row">
                                            <div className="col-sm-12 Set_news_portal">
                                                <a rel="noopener noreferrer" href={pack.url} target="_blank">
  ...
  &nbsp;<span id="date">{pack.date}</span>
                                                    ...
                                                    <a className="Set_WebLink" rel="noopener noreferrer" href={pack.link} target="_blank">{pack.link}</a>
